# Pexels Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Pexels Trademarks Logo. They did publish a trademark guideline and supplied
an required but incompatible matiral files for it. The preferred version is
...
This project re-draws Pexels Trademarks Logo specifically for 1200x1200 size.
...
Since Pexels published its brand and trademark guideline, **you MUST go through
each of the following to avoid any unwanted legal implications**:

* https://help.pexels.com/hc/en-us/articles/900005851903-How-should-I-give-credit-Can-I-use-your-logo

While not specified by Pexels, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Pexels Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-pexels-1200x1200
UUID: 11E0161E-6F8B-4348-95B7-A45FA20F5523
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-20
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-pexels-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH PEXELS TRADEMARK REQUIREMENTS**.
>
